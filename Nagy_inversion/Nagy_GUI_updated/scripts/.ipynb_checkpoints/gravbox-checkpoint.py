...
def gravbox(x0,y0,z0,x1,x2,y1,y2,z1,z2,rho):
    ...
    anomaly=0.00667*rho*(
        u1*(sp.log((v2+r122)/(v2+r121))-sp.log((v1+r112)/(v1+r111))) -
        u2*(sp.log((v2+r222)/(v2+r221))-sp.log((v1+r212)/(v1+r211))) +   
        v1*(sp.log((u2+r212)/(u2+r211))-sp.log((u1+r112)/(u1+r111))) -
        v2*(sp.log((u2+r222)/(u2+r221))-sp.log((u1+r122)/(u1+r121))) +
