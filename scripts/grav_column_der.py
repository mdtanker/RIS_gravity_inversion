...
'''
from the Hammer prism approximation with annulus, as shown on pg. 31, eq:2.19, of Jack McCubbine's thesis
'''
...
def grav_column_der(x0,y0,z0,xc,yc,z1,z2,res,rho):
    ...
    anomaly_grad=0.0419*f*rho*(z1-z0)*(1/np.sqrt(r2**2+(z1-z0)**2)-1/np.sqrt(r1**2+(z1-z0)**2)) # fabio's original
